    ...
    return isPressed ? NextBagOfTrade() :  Column(
      children: [
         Padding(
           ...
           child: SizedBox(child: Text("Start now by registering as a trader within Asti to reach millions of subscribers in the shortest possible time",
        ...
        Form(
            child: Column(
              children: [
                CustomTextFormFeild3(hintText: "Enter the trade name", controller: controller,
                  label: SizedBox(
                    width: width / 4,
                    child: Row(
                      children: [
